            ...
            {Array(5)
                ...
                .map((_, i) => {
                    ...
                    if (roundedRating - i >= 1)
                        return <BsStarFill key={i} style={{ marginLeft: '1' }} color={i < rate ? 'orange' : 'orange.300'} />
            ...
            <Box className="product-card"
                ...
                <Box p="6">
                    <Box display="flex" alignItems="baseline">
                        <Badge rounded="full" px="2" fontSize="0.8em" colorScheme="white" color="red">
                            {brand?.name}
                        </Badge>
                    </Box>
                    ...
                    <Flex mt="1" justifyContent="space-between" alignContent="center">
                        ...
                        <Tooltip
                            ...
                            <chakra.a href={'#'} display={'flex'}>
                                <Icon as={FiShoppingCart} h={7} w={7} alignSelf={'center'} color="red" />
                            </chakra.a>
                        </Tooltip>
                    </Flex>
